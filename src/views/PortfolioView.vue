  ...
  data() {
    return {
      ...
      items: [
        {
          id: 1,
          name: 'Recovery U Computer',
          imageUrl: 'recovery',
          status: 'web-based application - Help Center',
          tech: 'HTML, CSS, JavaScript, PHP, SQL',
          github: 'https://github.com/amirsr43/recovery',
          demo: 'https://www.figma.com/design/NHsZUX1zeGJYLjfDHWR8FG/help-center?node-id=0-1&t=O4ikqntzam3WicrM-1'
        },
        {
          id: 2,
          name: 'LibraNation',
          imageUrl: 'LibraNation',
          status: 'Library Application',
          tech: 'Ionic, Android Studio',
          github: 'https://github.com/amirsr43/App-LibraNation',
          demo: 'https://www.figma.com/design/cDxk6QC3lvjQbbRAYHQry7/design-mobile?node-id=593-10&t=Fnr2MWGrBZ7WUhs3-1'
        },
        {
          id: 3,
          name: 'PT. Arjuna Indratama',
          imageUrl: 'ArjunaIndratama',
          status: 'Web Company Profile',
          tech: 'React js, Laravel, Tailwind CSS, Bootstrap, API',
          github: {
            frontend: 'https://github.com/amirsr43/Arjuna-Indratama.git',
            backend: 'https://github.com/amirsr43/admin-panel.git'
          },
          demo: 'https://www.figma.com/design/z64HVzJ7i1KVrpck2wlNvh/Untitled?node-id=0-1&p=f&t=1GJwBd6jwAiCnShF-0'
        },
      ]
    };
  }
              ...
              <div
                ...
                <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div class="w-full text-left text-[10px] text-[#c1c1c1] md:text-xs lg:text-sm">
                    {{ item.status }}</div>
                  <div class="w-full mt-4 text-normal text-sm text-left text-blue-400">
                    {{ item.tech }}
                  </div>
                  <div class="w-full flex justify-end">
                    <div class="flex cursor-pointer items-end gap-2 text-primary">
                      <a v-if="item.github.frontend" :href="item.github.frontend" target="_blank" rel="noreferrer"
                        title="View Front-end repository" class="transition-all hover:text-accent">
                        <span>Front-end</span>
                      ...
                      <a v-if="item.github.backend" :href="item.github.backend" target="_blank" rel="noreferrer"
                        title="View Back-end repository" class="transition-all hover:text-accent ml-2">
                        <span>Back-end</span>
                        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24"
                          stroke-linecap="round" stroke-linejoin="round" height="16" width="16"
                          xmlns="http://www.w3.org/2000/svg">
                      ...
                      <a v-else :href="item.github" target="_blank" rel="noreferrer" title="View GitHub repository"
